...
Student Name: Ayush Pateriya
Roll Number: 24BAI10067
...
Notes
All scripts are tested on Ubuntu 22.04 LTS. For other distributions, adjust package manager commands. This completes the full LibreOffice Audit project for Ubuntu 22.04 LTS. All scripts are ready to run, and the report provides comprehensive coverage of the origin story, license analysis, ethical reflections, Linux footprint, ecosystem mapping, and comparison with proprietary alternatives.
